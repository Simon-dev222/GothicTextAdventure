...
print_slow("\nVerschwommen siehst Du die Konturen des Ufers.")
print_slow("\nMit letzter Kraft schwimmst Du darauf zu und ziehst Dich an Land.")
print_slow("\nVor Dir stampft ein Fuß in den Matsch.")
print_slow("\nDu blickst auf. \nMehrere, in Fetzen aus Lumpen und verrotteten Rüstungsteilen gekleidete Gefangene stehen mit verschränkten Armen über Dir.")
print_slow("\nDer Kerl direkt vor Dir beugt sich herab, zieht Deinen Kopf an den Haaren hoch und blickt Dir direkt ins Auge")
print_slow(f"{RED}""Bloodwyn raunt mit stinkendem Atem aus seinem Zahlosen Mund: "f"{BLUE}""Willkommen im Lager!")